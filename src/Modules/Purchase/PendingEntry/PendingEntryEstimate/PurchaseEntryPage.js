...
export const PurchaseEntryPage = ({ getPurch, setSaleorder }) => {
  ...
  console.log(tableProducts, 'ITEM NAME');
  ...
  const GetSaleCustomer = () => {
    request.get('purchase/supplier_list_item_detail/')
      .then(function (response) {
        console.log(response.data, 'supplier_list_item_detail');
...
useEffect(() => {
  ...
  console.log('called1 rr', newDecimal)
  console.log('called1 totalAmt', totalAmt)
  ...
  return (
    <Fragment>
      <Form name="sales"
        ...
        autoComplete="off"
      >
        <PurchaseFormHeader setSaleorder={setSaleorder} setSelectedSupplierDetails={setSelectedSupplierDetails} trigger={trigger} setProductList={setProductList} GetSaleCustomer={GetSaleCustomer} />
