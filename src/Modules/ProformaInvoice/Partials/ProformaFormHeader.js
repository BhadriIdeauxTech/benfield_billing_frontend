        ...
        <Fragment>
            ...
            <Row gutter={[24, 24]} >
                ...
                <Col span={24} md={16}>
                    ...
                    <Row gutter={[12, 12]}>
                        <Col span={24} md={12}>
                            ...
                            {click ? (
                                <CustomSelect options={SaleMobiles} onButtonClick={onViewRow}
                                    style={{ textTransform: 'uppercase' }} buttonLabel="Add Customer"
                                    onChange={handleSelectedSale} showSearch={true} label={'Customer Name'}
                                    name={'customer_name'} placeholder={'Customer Name'} rules={[
                                        {
                                            required: true,
                        ...
                        <Col span={24} md={12}>
                            {click ? (
                                ...
                                <CustomSelect options={SaleCompanies} onButtonClick={onViewRow} style={{ textTransform: 'uppercase' }} showSearch={true} buttonLabel="Add Customer" onChange={handleSelectCompany} label={'Company Name'} name={'company_name'} placeholder={'Company Name'} rules={[
                                    {
                                        required: true,
                                        message: 'This is required field!',
                                    }
                ...
                <Col span={24} md={8}>
                    <Row>
                        <Col span={24} md={24}>
                            <CustomInputNumber label={'Proforma Invoice Number'}
                             precision={0} name={'invoice_no'} 
                             disabled placeholder={'Invoice Number'} />
                        </Col>
                        <Col span={24} md={24}>
                        ...
                        <Col span={24} md={24}>
                            <Input label={'GST IN'} name={'GSTIN'} placeholder={'GST IN'} style={{ textTransform: 'uppercase' }}
                            //  rules={[
                            //     {
                            //         required: true,
