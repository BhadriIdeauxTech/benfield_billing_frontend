...
export const BillDetNow = ({ record, Company }) => {
            ...
            <Cardsin>
                <Row>
                    <Col span={24} md={12} style={{ borderRight: '1px solid', borderBottom: '1px solid', padding: '2px 10px' }}>
                        ...
                        {/* <FormTitle Title={''} /> */}
                        <h5 style={{ fontSize: '14px', fontWeight: '600', textTransform: 'uppercase' }}> {Company.business_name}</h5>
                        <p style={{ fontSize: '12px', fontWeight: '500', textTransform: 'uppercase' }}>{Company.address}</p>
                        <p style={{ fontSize: '12px', fontWeight: '500', textTransform: 'uppercase' }}>{Company.phone_no} , {Company.phone_no2}</p>
                        <p style={{ fontSize: '12px', fontWeight: '500', }}>E-Mail :&nbsp;{Company.email}</p>
                        <p style={{ fontSize: '12px', fontWeight: '600', textTransform: 'uppercase' }}>GSTIN :&nbsp;<span style={{ textTransform: 'uppercase', fontSize: '12px', fontWeight: '600' }}>{Company.gstin}</span></p>
    ...
    const BottomFooterComponent = () => {
        return (
            ...
            //                 <div style={{ textAlign: 'start' }}>
            //                     <div style={{ textAlign: 'start' }}>
            //                         <span style={{ textTransform: 'capitalize' }}>:&nbsp;&nbsp;<b>{Company.bankname}</b></span>
            //                     </div>
            //                     <div style={{ textAlign: 'start' }}>
            //                         <span>:&nbsp;&nbsp;<b>{Company.account_no}</b></span>
            //                     </div>
            //                     <div style={{ textAlign: 'start' }}>
            //                         <span style={{ textTransform: 'capitalize' }}>:&nbsp;&nbsp;<b>{Company.branch} &</b></span>
            //                         <span style={{ textTransform: 'uppercase' }}>&nbsp;<b>{Company.ifsc_code}</b></span>
            //                     </div>
            //                     <div style={{ textAlign: 'start' }}>
            //                     </div>
            //                 </div>
            ...
            //             <Col span={12} style={{ textAlign: 'end' }}><b>for<span style={{ fontSize: '15px', fontWeight: '600', textTransform: 'uppercase' }}> {Company.companyname}</span></b></Col>
            //         </Row>
            ...
            <div style={{ pageBreakInside: 'avoid', margin: '10px 0' }}>
                ...
                <Row gutter={[12, 12]}>
                    ...
                    <Col span={24} md={12}>
                        ...
                        <Flex gap={'5px'}>
                            ...
                            <div style={{ textAlign: 'start' }}>
                                <div style={{ textAlign: 'start' }}>
                                    <PrintTitle Size={'14px'} UPPER Weight={'600'} style={{ textTransform: 'uppercase' }}>:&nbsp;&nbsp;{Company.bank_account_name}</PrintTitle>
                                </div>
                                <div style={{ textAlign: 'start' }}>
                                    <PrintTitle Size={'14px'} UPPER Weight={'600'} style={{ textTransform: 'uppercase' }}>:&nbsp;&nbsp;{Company.bank_name}</PrintTitle>
                                </div>
                                <div style={{ textAlign: 'start' }}>
                                    <PrintTitle Size={'14px'} UPPER Weight={'600'} style={{ textTransform: 'uppercase' }} >:&nbsp;&nbsp;{Company.bank_account_number}</PrintTitle>
                                </div>
                                <div style={{ textAlign: 'start' }}>
                                    <PrintSubTitle Size={'14px'} UPPER Weight={'600'} style={{ textTransform: 'uppercase' }}>:&nbsp;&nbsp;{Company.bank_branch}&nbsp;&</PrintSubTitle>
                                    <PrintSubTitle Size={'14px'} UPPER Weight={'600'} style={{ textTransform: 'uppercase' }}>&nbsp;{Company.ifsc_code}</PrintSubTitle>
                                </div>
                                {/* <div style={{ textAlign: 'start' }}>
                                </div> */}
                            </div>
                ...
                <div style={{ border: '1px solid', padding: '2px 10px', marginTop: '5px' }}>
                    <Row>
                        ...
                        <Col span={12} style={{ textAlign: 'end',textTransform: 'uppercase' }}><b>for</b><PrintSubTitle Size={'14px'} Weight={'600'} UPPER> {Company.business_name}</PrintSubTitle></Col>
                    </Row>
    ...
    return (
        <Fragment>
            <Flex gap={'20px'} centerVertically>
                ...
                <PDFDownloadLink fileName={`Quotation-${record?.company_name}${record?.invoice_date}`} document={<PDFMaker record={record} />}>
