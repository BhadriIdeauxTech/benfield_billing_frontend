...
const Footer = ({ record }) => {
    ...
    const AllTotalGST = (val1, val2, val3, val4) => {
        // 
        const amount = parseFloat(val1) || 0 + parseFloat(val2) || 0 + parseFloat(val3) || 0 + parseFloat(val4) || 0;
            ...
            {/* <Row>
                <Col span={24} md={10}>
                    <Row>
                        ...
                        <Col span={24}>
                            <Box right bottom>
                                <h6 style={{ textAlign: 'right' }}>{formatAmounts(formattedNoTaxAmt)}</h6>
                            </Box>
                        </Col>
                        <Col span={24}>
                            <Box right bottom>
                ...
                <Col span={24} md={14}>
                    <Row>
                        ...
                        <Col span={6}>
                            <Row>
                                <Col span={24}>
                                    <Box><h6 style={{ textAlign: 'center',marginBottom:'1px' }}>CGST</h6></Box>
                                </Col>
                                <Col span={24}>
                                    <Box bottom><h6 style={{ textAlign: 'center' }}>Tax Amount</h6></Box>
                                </Col>
