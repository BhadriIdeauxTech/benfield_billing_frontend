                    ...
                    </tr>
                    {
                        record?.total_cgst_12_percentage == "0.00" && record?.total_cgst_18_percentage == "0.00" ? ('') : (
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><h6 style={{ fontSize: '12px', fontWeight: '500', borderTop: '1px solid black', paddingTop: '4px' }}>'{formatAmounts(formattedCgst)}'</h6></td>
                            </tr>
                        )
                    }
                    {
                        record?.total_sgst_12_percentage == "0.00" && record?.total_sgst_18_percentage == "0.00" ? ('') : (
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><h6 style={{ fontSize: '12px', fontWeight: '500', borderTop: '1px solid black', paddingTop: '4px' }}>'{formatAmounts(formattedSgst)}'</h6></td>
                            </tr>
                        )
                    }
