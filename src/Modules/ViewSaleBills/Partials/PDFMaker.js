...
export const PDFMaker = ({ record }) => {
    ...
    const Header = () => {  
        return (
            <>
            <Text style={{textAlign:'center',marginBottom:'10px',fontSize:'12px',fontWeight:'500'}}>Invoice Bill</Text>
            ...
            <View style={{ position: 'absolute', bottom: '0', left: '0', width: '100vw', padding: '10px 30px' }}>
                <View style={{ marginTop: '50px' }}>
                    <View style={{ display: 'flex', flexDirection: 'row' }}>
                        ...
                        {record?.total_cgst_12_percentage === "0.00" ? <View style={{ flex: '0.5', alignItems: "flex-end" }}>
                                ...
                                <Text style={{ fontSize: '11px', fontWeight: '500', marginBottom: '10px' }}>Less&nbsp;:&nbsp;&nbsp;Round Off&nbsp;:&nbsp;</Text>
                            </View>:null}
                            {record?.total_cgst_12_amount === "0.00" ?<View style={{ flex: '0.5', alignItems: "flex-end" }}>
                                ...
                                <Text style={{ fontSize: '11px', fontWeight: 'bold', marginBottom: '10px' }} >(-){formattedroundOff}</Text>
                            </View>:null}
                        </View>
                    </View>
                    <View style={{ display: 'flex', flexDirection: 'row', }}>
    ...
    const TableHeadings = () => {
        return (
            <View style={{ display: 'flex', flexDirection: 'row', border: '1px solid black', marginTop: '10px', }}>
                ...
                <View style={{ flex: '2.5', borderRight: '1px solid black', padding: '10px 0' }}>
            ...
            {Array.from({ length: totalPages }, (_, pageIndex) => (
                <Page key={pageIndex} style={{ padding: '40px 30px' }}>
                    ...
                    {record?.sales
                        ...
                        .map((value, index) => {
                            const formattedAmount = (value?.item_amt_no_gst || value?.item_cal_total_amt).toLocaleString('en-IN', { minimumFractionDigits: 2 });
                            ...
                            return (
                                <>
                                    <View style={{ display: 'flex', flexDirection: 'row', }}>
                                        ...
                                        <View style={{ flex: '2.5', padding: '5px 0', borderBottom: '1px solid black', borderRight: '1px solid black' }}>
                                            <Text style={{ fontSize: '10px', textAlign: 'center' }}>{value.item_name}</Text>
                                        </View>
                                        <View style={{ flex: '0.5', padding: '5px 0', borderBottom: '1px solid black', borderRight: '1px solid black' }}>
