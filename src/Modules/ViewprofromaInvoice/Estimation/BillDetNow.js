    ...
    return (
        <Fragment>
            <Flex gap={'20px'} centerVertically>
                ...
                <PDFDownloadLink fileName={`Estimate Proforma invoice-${record?.company_name}${record?.invoice_date}`} document={<PDFMaker record={record} />}>
                    ...
                    <Row gutter={[12, 12]}>
                        <Col span={14}>
                            <div style={{ textAlign: 'center' }}>
                                <InvoiceTitle Title={'Estimate Proforma'} />
                            </div>
                        </Col>
                        <Col span={10}>
