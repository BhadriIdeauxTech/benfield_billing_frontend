...
export const SalesFormHeader = ({ setSale, setSelectedDate, setReload, setSelectedSale, setInvoiceNumber, trigger, selectedSale }) => {
            ...
            <Row gutter={[24, 24]} >
                ...
                <Col span={24} md={16}>
                    ...
                    <Row gutter={[12, 12]}>
                        ...
                        <Col span={24} md={12}>
                            <Input showSearch label={'Mobile Number'} placeholder={'Enter Mobile Number'}
                ...
                <Col span={24} md={8}>
                    <Row>
                        <Col span={24} md={24}>
                            <CustomInputNumber label={'Sale Invoice Number'} precision={0} name={'invoice_no'} disabled placeholder={'Invoice Number'} />
                        </Col>
                        <Col span={24} md={24}>
