...
export const SalesFormHeader = ({ setSaleorder, setSelectedDate,Setreset, setProductList, setReturnNumber,setSample, trigger, setSelectedSupplierDetails, setSelectedSupplierBillDetails }) => {
    // ======  Modal Open ========
    ...
    const GetReturnNo = () => {
        request.get('sales/get_detail_sale_return/')
    ...
    const GetCustomerBiils = (id) => {
        request.post('sales/sale_invoice_no/', {
            customer: id
        }
        )
            .then(function (response) {
    ...
    const GetSupplierBiilsDetails = (id) => {
        request.post('sales/sale_return_pro_detail/', {
            sale: id
        }
        )
            .then(function (response) {
                    ...
                    <Row gutter={[12, 12]}>
                        <Col span={24} md={12}>
                            ...
                            {click ? (
                                ...
                                <CustomSelect options={CustomerMobile} style={{ textTransform: 'uppercase' }} onButtonClick={onViewRow} buttonLabel="Add Customer" label={'Customer Name'} name={'customer_name'} placeholder={'Customer Name'} disabled />
                            )}
                        </Col>
                        ...
                        <Col span={24} md={12}>
                            <Input label={'GST IN'} style={{ textTransform: 'uppercase' }} disabled name={'gstin'} placeholder={'GST IN'} />
                        </Col>
