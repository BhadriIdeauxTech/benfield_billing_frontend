...
import { Cardsin, Maindesign, Tablecss } from './TableStyle'
        ...
        return (
            <Cardsin>
                <Row>
                    ...
                    <Col span={24} md={12} >
                        <Row>
                            <Col span={24} md={12} style={{ textAlign: 'center',textTransform: 'uppercase'}} >
                ...
                <Row>
                    <Col span={24} md={12} style={{ borderRight: '1px solid', padding: '2px 10px' }}>
                        ...
                        <br />
                        <p style={{ fontSize: '12px', fontWeight: '600', }}>GSTIN :&nbsp;<span style={{ textTransform: 'uppercase', fontSize: '12px', fontWeight: '600' }}>{record.GSTIN}</span></p>
                    ...
                    <Col span={24} md={12} style={{ justifyContent: 'end', display: 'flex', textAlign: 'end' }}>
                        <Col span={24} md={24}>
                            <Row gutter={[12, 12]}>
                                ...
                                <Col span={24} md={16}>
                                    <div>
                                        <PrintSubTitle Size={'12px'} Weight={'600'} style={{textTransform: 'uppercase'}}>Less&nbsp;:&nbsp;&nbsp;Round Off&nbsp;:&nbsp;</PrintSubTitle><br />
                                    </div>
                                </Col>
                                <Col span={24} md={8}>
                                    <div>
            ...
            <div style={{ pageBreakInside: 'avoid', margin: '10px 0' }}>
                    ...
                    <Col span={24} md={12}>
                        ...
                        <Flex gap={'5px'}>
                            <div style={{ textAlign: 'start' }}>
                                ...
                                <div style={{ textAlign: 'start' }}>
                                    <PrintTitle Size={'14px'} >A/c No.&nbsp;</PrintTitle>
                                </div>
                                <div style={{ textAlign: 'start' }}>
                                    <PrintSubTitle Size={'14px'}style={{textTransform: 'uppercase' }} >Branch&nbsp;</PrintSubTitle>&nbsp;&&nbsp;
                                    <PrintSubTitle Size={'14px'} >IFS&nbsp;code&nbsp;</PrintSubTitle>
                                </div>
                                {/* <div style={{ textAlign: 'start' }}>
                ...
                <div style={{ border: '1px solid', padding: '2px 10px', marginTop: '5px' }}>
                    <Row>
                        ...
                        <Col span={12} style={{ textAlign: 'end',textTransform:'uppercase' }}><b>for</b><PrintSubTitle Size={'14px'} Weight={'600'} UPPER style={{textTransform: 'uppercase' }} > {companyProfile.business_name}</PrintSubTitle></Col>
                    </Row>
    ...
    return (
        <Fragment>
            <Flex gap={'20px'} centerVertically>
                ...
                <PDFDownloadLink fileName={`Estimate-${record?.company_name}${record?.invoice_date}`} document={<PDFMaker record={record} />}>
                    ...
                    <Row gutter={[12, 12]}>
                        <Col span={14}>
                            <div style={{ textAlign: 'center' }}>
                                <InvoiceTitle Title={'ESTIMATE BILL'} />
                            </div>
                        </Col>
                        <Col span={10}>
